...
public class Chat extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            channel = new NotificationChannel("LGMM", "LGMM", NotificationManager.IMPORTANCE_DEFAULT);
    ...
    private void login() {
        if (CometChat.getLoggedInUser() == null || CometChat.getLoggedInUser().getUid() != mAuth.getUid()) {
        ...
        if (CometChat.getLoggedInUser() != null) {
            CometChat.logout(new CometChat.CallbackListener<String>() {
                ...
                public void onSuccess(String s) {
                    Toast.makeText(Chat.this, "User successfully logged out.", Toast.LENGTH_SHORT).show();
                }
            ...
            public void OnItemClick(Group g, int position) {
                ...
                if (group.isJoined()) {
                    ...
                    if (group.getGroupType().equals(CometChatConstants.GROUP_TYPE_PASSWORD)) {
                        ...
                        new CustomAlertDialogHelper(Chat.this, getResources().getString(R.string.password), dialogview, getResources().getString(R.string.join),
                                "", getResources().getString(R.string.cancel), Chat.this, 1, false);
    ...
    private void joinGroup(Group group) {
        FeatureRestriction.isJoinOrLeaveGroupEnabled(new FeatureRestriction.OnSuccessListener() {
            ...
            public void onSuccess(Boolean booleanVal) {
                if (booleanVal) {
                    progressDialog = ProgressDialog.show(Chat.this, "", getResources().getString(R.string.joining));
                    ...
                    CometChat.joinGroup(group.getGuid(), group.getGroupType(), groupPassword, new CometChat.CallbackListener<Group>() {
                        ...
                        public void onError(CometChatException e) {
                            ...
                            CometChatSnackBar.show(Chat.this,
    ...
    public void addConversationListener() {
        CometChat.addMessageListener(TAG, new CometChat.MessageListener() {
            ...
            public void onTextMessageReceived(TextMessage message) {
                ...
                NotificationCompat.Builder builder = new NotificationCompat.Builder(Chat.this, "LGMM");
                ...
                builder.setContentTitle(message.getSender().getName());
                builder.setContentText(message.getText());
                builder.setSmallIcon(com.appdev.lgmm.R.drawable.logo);
    ...
    private void startUserIntent(User user) {
        Intent intent = new Intent(Chat.this, CometChatMessageListActivity.class);
