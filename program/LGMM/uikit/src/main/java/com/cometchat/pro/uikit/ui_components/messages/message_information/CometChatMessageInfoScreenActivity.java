            ...
            if (messageType.equals(CometChatConstants.MESSAGE_TYPE_TEXT)) {
                ...
                try {
                    ...
                    for (int i = 0; i < options.length(); i++) {
                        ...
                        textViewOption.setTextAppearance(this, com.cometchat.pro.R.style.Base_TextAppearance_AppCompat_Medium);
                        textViewPercentage.setTextAppearance(this, com.cometchat.pro.R.style.TextAppearance_AppCompat_Medium);
